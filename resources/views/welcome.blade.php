                        ...
                        <div class="center-section " style="">
                            <div class="box">
                                <form action="\category" id="search-form">
                                    ...
                                    <button form="search-form" class="search" type="submit"><i class="fa fa-search"
                    ...
                    <div class="product product-style-2 equal-elem ">
                        <div class="product-thumnail">
                            <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                <figure><img src="images/products/digital_04.jpg" width="800" height="800"
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span
                                                    class="product-price">{{$product->product_price}}</span></div>
                                            <div>
                    ...
                    <div class="wrap-products">
                        <div class="wrap-product-tab tab-style-1">
                            ...
                            <div class="tab-contents">
                                    ...
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                        ...
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="wrap-price"><span
                                                        class="product-price">${{ $product->product_price }}</span>
                                                </div>
                                                <div>
                                                    <form action="/add_to_cart" method="POST">
                                                        @csrf
                                ...
                                <div class="tab-content-item" id="fashion_1a">
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                        ...
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                <a href="#"
                                                    class="product-name"><span>{{$smartphone->product_name}}</span></a>
                                                <div class="wrap-price"><span
                                                        class="product-price">${{$smartphone->product_price}}</span>
                                                </div>
                                            </div>
                                            <div>
                                                <form action="/add_to_cart" method="POST">
                                ...
                                <div class="tab-content-item" id="fashion_1b">
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container "
                                        ...
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                <a href="#"
                                                    class="product-name"><span>{{ $washingmachine->product_name}}</span></a>
                                                <div class="wrap-price"><span class="product-price">$250.00</span></div>
                                                <div>
                                                    <form action="/add_to_cart" method="POST">
                                                        @csrf
                                ...
                                <div class="tab-content-item active" id="fashion_1c">
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                        data-items="5" data-loop="false" data-nav="true" data-dots="false"
                                        data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                                        ...
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                <a href="#"
                                                    class="product-name"><span>{{ $laptop->product_name}}</span></a>
                                                <div class="wrap-price"><span
                                                        class="product-price">${{ $laptop->product_price }}</span>
                                                </div>
                                                <div>
                                                    <form action="/add_to_cart" method="POST">
                                                        @csrf
                                ...
                                <div class="tab-content-item active" id="fashion_1d">
                                    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                        data-items="5" data-loop="false" data-nav="true" data-dots="false"
                                        data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
